...
#define HRM_CREST_FACTOR_THRESH_FINGERTIP 10
...
// Do not run PS AGC
#define HRM_PS_AGC                        0   // 1--Increase LED current during valid HR if PS is below the work level or PI is below 0.2%(could occur on wrist).
