#  Proyecto Final Giorgi-Lauritto - Oximetría de Pulso (ODP)
...
Además de el coneccionado del bus I2C, es necesario conectar el pin EN del módulo a 3.3V y la salida INT a un pin del ESP32, en el proyecto se utiliza el pin 1. 
